<?php
    ...
    if(isset($_POST['name'])){
        ...
        $sql = "INSERT INTO `trip`.`bbus` (`Name`, `Age`, `Gender`, `Email`, `Phone`, `From`, `To`, `departure`,`Date_time`) VALUES ('$name', '$age', '$gender', '$email', '$phone', '$from', '$to', '$departure', current_timestamp());";
        // echo $sql;
...
<body>
    <div class="container">
        ...
        <form action="" method="post">
            ...
            <input type="text" id="from" name="from" placeholder="Enter your Pikeup point">
            <input type="text" id="to" name="to" placeholder="Enter your Drop point">
            <input type="date" id="departure" name="departure" placeholder="Enter your Travel Date : 27/10/2022">
